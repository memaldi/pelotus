...
let PlayersController = class PlayersController {
    ...
    getPlayersByTeamAndPosition(teamId, seasonId, position) {
        return this.playersService.getPlayersByTeamPosition(teamId, seasonId, position);
    }
};
exports.PlayersController = PlayersController;
__decorate([
    (0, common_1.Get)("team/:teamId/season/:seasonId/player/position/:position"),
...
], PlayersController.prototype, "getPlayersByTeamAndPosition", null);
